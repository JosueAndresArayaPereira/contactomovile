...
import com.example.contactomovile.adapters.RecentConversationsAdapter;
import com.example.contactomovile.databinding.ActivityMainBinding;
import com.example.contactomovile.listeners.ConversionListener;
...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void updateToken(String token){
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                .addOnFailureListener(e -> showToast("error al actualizar token"));
    }
    ...
    private void singOut(){
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e -> showToast("Error al cerrar sesion"));
    }
